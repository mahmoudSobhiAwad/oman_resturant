...
class VerifyNumberInSignUpUseCase extends UseCase<String, SignUpParams> {
  final SignUpRepo signUpRepo;

  VerifyNumberInSignUpUseCase({required this.signUpRepo});

  @override
  Future<Either<Failures, String>> call(SignUpParams params) async {
    return await signUpRepo.verifyNumber(params: params);
  }
}
